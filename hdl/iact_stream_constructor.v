      ...
      if (!rst_ni) begin
        ...
        case (fsm_enc_current_state)
          ...
          ENCODE: begin
            ...
            if (((ram_inc_counter[7:0] + 1 - (iact_channels_i%2)) % WORDS_PER_CYCLE[7:0] == WORDS_PER_CYCLE[7:0] - 1) | 
            (WORDS_PER_CYCLE[7:0] == 1)) begin
            ...
            if (ram_inc_counter[7:0] == (iact_channels_i - 1)) begin
              ram_inc_counter <= 0;
            end
            if (fsm_row_offset != y_cluster_counter) begin
              ram_rd_addr <= ram_rd_addr;
