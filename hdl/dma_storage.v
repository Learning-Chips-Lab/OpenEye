...
module dma_storage (
    ...
    output reg [12:0] needed_iact_buffer_words_reg,
    output reg [1:0] add_up_reg
);
...
always @(posedge clk_i, negedge rst_ni) begin
    if (!rst_ni) begin  ///Reset
        ...
        send_data_out <= 1'd0;
        needed_iact_buffer_words_reg <= 13'd0;
        add_up_reg <= 2'd0;
        ...
        case (write_addr)
            ...
            3: begin
                needed_iact_buffer_words_reg <= dma_data_i[PARAMETER_POS_3_0 + 12 : PARAMETER_POS_3_0];
                add_up_reg <= dma_data_i[PARAMETER_POS_3_1 + 1 : PARAMETER_POS_3_1];
            end
        endcase
    end
end
