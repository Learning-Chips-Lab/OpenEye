...
def create_vh_file_from_envvars(file_path_vh = None, file_path_hdl = None, toplevel = None):
    """Create VH file from environment variables."""
    
    file_path_hdl = file_path_hdl if file_path_hdl else hdl_dir
    file_path_vh = file_path_vh if file_path_vh else os.path.abspath(os.curdir)

    create_vh_file(file_path_vh + "/pre_parameters.vh")
